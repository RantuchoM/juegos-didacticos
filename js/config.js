...
export const MSG_CINCO_EJERCICIOS = '¡Muy bien, hiciste cinco ejercicios!';
export const VINCULAR_GRUPOS = 4;
export const VINCULAR_NUMEROS_SIN_PAR = 2;
export const EMOJIS_CONTAR = ['🍎', '⭐', '🐟', '🌸', '⚽', '🐞', '🍪', '🎈', '🚗', '🦋'];
export const NIVELES_CONTAR_UNIR = [
    { max: 10, label: '1 – 10' },
    { max: 14, label: '1 – 14' },
    { max: 20, label: '1 – 20' }
];
export const NIVELES_MAT = [
    { max: 5, label: '1 – 5', pares: 2 },
    { max: 10, label: '1 – 10', pares: 2 },
    { max: 15, label: '1 – 15', pares: 3 },
    { max: 20, label: '1 – 20', pares: 3 },
    { max: 99, label: '1 – 99', pares: 3 }
];
